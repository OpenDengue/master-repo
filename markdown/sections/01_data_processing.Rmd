...
file_list<-list.files("data/raw_files/PAHO"); file_list

old_dir<-paste0("data/raw_files/PAHO")
new_dir<-paste0("data/source_files/PAHO")
...
gaul_codes_world <- read.csv(file="data/ref_data/gaul_codes_world.csv")
...
write.csv(all_dt_A_tidy,"data/processed_data/PAHO_processed_A.csv", row.names = FALSE)
```
...
write.csv(all_dt_B_tidy,"data/processed_data/PAHO_processed_B.csv", row.names = FALSE)
```
