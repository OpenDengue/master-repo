...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE, fig.path = "../docs/figure/PAHO/")
...
```{r child = 'markdown/sections/01_data_processing.Rmd'}
...
```{r child = 'markdown/sections/04_data_revision_imputation.Rmd'}

```

# Visualisations
```{r child = 'markdown/sections/05_visual.Rmd'}
