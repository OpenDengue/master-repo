...
require(here); require(dplyr); require(stringr); require(lubridate)
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE, fig.path="figure/")
knitr::opts_knit$set(root.dir = here())

pacman::p_load("dplyr", "lubridate",  "tidyr", "tidyverse",  "knitr", "stringi", "zoo", "EpiWeek", "data.table", "ggplot2", "sf", 'rnaturalearth', "sf", "rnaturalearthdata")
...
```{r Data preprocessing, include = FALSE, eval=FALSE}
#* This part could be merged into earlier data processing stage
db1 <- read.csv(here("data", "moh_pahosubnational_tycho_merge.csv"))
db2 <- read.csv(here("data", "paho_for_opendengue.csv"))
colnames(db1)
...
#write.csv(data, here("data", "master_data.csv"), row.names=F)
```
<!--
...
data <- read.csv(here("data", "master_data.csv"))
head(data)
plyr::count(data$source_cat)
...
lookup_order <- read.csv(here("data", "heatmap_order.csv"))
names(lookup_order)
